...
This repository hosts the DAIOE (Direct AI Occupational Exposure) index across multiple occupational classifications. Each dataset folder includes `.csv`, `.dta` (Stata), and `.xlsx` (Excel) files.
...
- `daioe_<flavour>.csv`, `daioe_<flavour>.dta`, `daioe_<flavour>.xlsx`
...
## Related
[Translation Helper Utility](https://github.com/joseph-data/07_translate_ssyk): English translation for SSYK 2012 and SSYK 96 occupation titles.
